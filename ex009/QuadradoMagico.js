...
var matrizQuadradaMagica = function () {
    ...
    //TRANSFORMANDO EM A RAIZ EM UM NUMERO INTEIRO PARA DEPOIS EFETUAR A COMPARACAO//PODE SER FEITO DE ALGUMAS FORMAS...USEI ESSAS DUAS COMO EXEMPLO//NESSA RETIREI AS CASAS DECIMAIS PASSANDO PARA UM NUMERO INTEIRO
    var calc2 = Number.parseInt(calc);
    //JA COM O ROUND...ELE TRANSFORMA NO NUMERO INTEIRO MAIS PROXIMO...EX.: 
    (x = Math.round(20.49) == 20) && (x = Math.round(20.5) == 21)
    ...
    //PEGAR OS PARAMETROS PASSADOS E TRANSFORMAR EM UMA MATRIZ QUADRADAvar 
    matriz = [];
    var arr = [];
    var cont = 0;
    var cont2 = 0;
    ...
    /QUADRADO Matematicamente, um Quadrado Mágico é uma matriz quadrada (mesmo número de linhas e colunas)de ordem n (n linhas e n colunas) cujos elementos (números naturais) variam sucessivamente de  1 até n.n(nxn) que são arrumados de modo que a soma de cada linha, cada umas das duas diagonais principais ou de cada coluna seja sempre uma constante./
    ...
    if (somal[0] != somad || somad != somad2) {//alert("Não é quadrada magica");
        retorno = 0;
